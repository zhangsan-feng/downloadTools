...
function sign_datail(params, userAgent) {
    // console.log(window.sign_abogus)
    // console.log(window.bdms)
    InitEvn()

    return window.sign_abogus(0, 1, 14, params, '', userAgent)
    // return sign_AB.sign(0, 1, 14, params, '', userAgent)
}

function sign_reply(params, userAgent) {
    return window.sign_abogus(0, 1, 8, params, '', userAgent)
}

export function ABogus(params, userAgent){

    let ab = sign_datail(params, userAgent)
    // console.log(ab)
    // params += "&a_bogus=" + ab
    return ab
}
